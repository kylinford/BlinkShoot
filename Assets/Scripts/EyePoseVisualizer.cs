...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class EyePoseVisualizer : MonoBehaviour
    {
        ...
        {
            if (m_Face.leftEye != null && Left == null )
            {
                Left = Instantiate(m_EyePrefab, m_Face.leftEye);
                Left.SetActive(false);
            }
            if (m_Face.rightEye != null && Right == null)
            {
                Right = Instantiate(m_EyePrefab, m_Face.rightEye);
